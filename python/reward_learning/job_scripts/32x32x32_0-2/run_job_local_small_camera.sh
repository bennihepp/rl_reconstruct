...
export DATA_PATH=$DATA_BASE_PATH/in_out_grid_32x32x32_0-1-2_greedy_train.lmdb
export TEST_DATA_PATH=$DATA_BASE_PATH/in_out_grid_32x32x32_0-1-2_greedy_test.lmdb
