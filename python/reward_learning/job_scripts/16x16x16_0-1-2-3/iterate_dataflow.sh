...
MODEL_PATH=$HOME/rl_reconstruct_models/reward_prediction_line_camera_big_scenes/${DATA_SIZE}/${JOB_ID}${MODEL_POSTFIX}

python ${RLRECONSTRUCT_PY_DIR}/reward_learning/iterate_dataflow.py \
    --shuffle false \
    --use-train-data true \
    --visualize false \
    \
