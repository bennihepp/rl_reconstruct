...
python ${RLRECONSTRUCT_PY_DIR}/reward_learning/train.py \
    ...
    --io.initial_validation_run false \
    --io.train_summary_interval 1 \
    --io.model_summary_interval 4 \
    --io.model_summary_num_batches 1 \
    --io.checkpoint_interval 2 \
    \
    ...
    --training.learning_rate_decay_epochs 1 \
    --training.learning_rate_decay_rate 0.7 \
    --training.learning_rate_decay_mode "exponential" \
    \
    --config config_0151.yaml \
    $@
