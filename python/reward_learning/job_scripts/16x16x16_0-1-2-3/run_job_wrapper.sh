...
export MODEL_PATH=$HOME/rl_reconstruct_models/reward_prediction_${CAMERA_NAME}_big_scenes/${DATA_SIZE}/${JOB_ID}
export LOG_PATH=$HOME/rl_reconstruct_logs/reward_prediction_${CAMERA_NAME}_big_scenes/${DATA_SIZE}/${JOB_ID}
