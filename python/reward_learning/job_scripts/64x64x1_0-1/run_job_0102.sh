...
python ${RLRECONSTRUCT_PY_DIR}/reward_learning/train.py \
    ...
    --io.model_summary_interval 2 \
    --io.model_summary_num_batches 1 \
    --io.validation_interval 2 \
    --io.test_model_summary_interval 2 \
    ...
    --training.learning_rate_decay_rate 0.50 \
    --training.learning_rate_decay_mode "inverse" \
    \
    --config config_0102.yaml \
    $@
