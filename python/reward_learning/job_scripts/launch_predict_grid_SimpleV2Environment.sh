...
for i in {91..91}; do
	...
	CMD+="inputDir=%2Fhdfs%2F$VC%2F${USERNAME}%2Freward_learning%2Fdatasets%2Fin_out_grid_16x16x16_0-1-2-3_SimpleV2Environment_greedy%2F&"
