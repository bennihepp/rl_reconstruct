...
export MODEL_PATH=$HOME/reward_learning/models/grid_prediction_small_camera/$JOB_ID
export LOG_PATH=$HOME/reward_learning/logs/grid_prediction_small_camera/$JOB_ID
