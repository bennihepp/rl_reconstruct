...
HDF5_DATA_STATS_PATH=$DATA_BASE_PATH/in_out_grid_8x8x8_0-1-2-3-4-5-6-7-8_greedy_train_stats.hdf5
...
function run_evaluation {
  ...
  if [ $POLICY_MODE == "prediction" ]; then
    ...
    CONFIG=$HOME/rl_reconstruct/python/reward_learning/job_scripts_8x8x8/config_${MODEL_NUM}.yaml
...
run_evaluation prediction 240 model.ckpt-273319
