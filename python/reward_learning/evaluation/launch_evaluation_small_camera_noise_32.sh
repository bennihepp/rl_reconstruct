...
HDF5_DATA_STATS_PATH=$DATA_BASE_PATH/in_out_grid_32x32x32_0-1-2_greedy_train_stats.hdf5
...
SESSION=evaluate_reward_predict_policy_noise-$ID
...
echo "----- launch_evaluation_small_camera_noise.sh -----"
echo "id=$ID"
...
function run_evaluation {
  ...
  if [ $POLICY_MODE == "prediction" ]; then
    ...
    CONFIG=$HOME/rl_reconstruct/python/reward_learning/job_scripts_32x32x32/config_${MODEL_NUM}.yaml
  ...
  # Evaluation script
  tmux send-keys -t $SESSION:4 "python $HOME/rl_reconstruct/python/reward_learning/evaluate_reward_predict_policy_noise.py \\" C-m \
  ...
  tmux send-keys -t $SESSION:4 " " \
      ...
      \
      "--depth-noise-sigma $5 \\" C-m \
      "--depth-noise-drop-prob $6 \\" C-m \
      \
      "--verbose" C-m
}
...
#run_evaluation prediction 40 model.ckpt-141949 "" 0.05 0.00
#run_evaluation prediction 40 model.ckpt-141949 "" 0.10 0.00
#run_evaluation prediction 40 model.ckpt-141949 "" 0.20 0.00

#run_evaluation prediction 40 model.ckpt-141949 "" 0.10 0.05
#run_evaluation prediction 40 model.ckpt-141949 "" 0.10 0.05
#run_evaluation prediction 40 model.ckpt-141949 "" 0.20 0.05

#run_evaluation prediction 40 model.ckpt-141949 "" 0.05 0.10
#run_evaluation prediction 40 model.ckpt-141949 "" 0.10 0.10
#run_evaluation prediction 40 model.ckpt-141949 "" 0.20 0.10

#run_evaluation prediction 40 model.ckpt-141949 "" 0.50 0.25

run_evaluation prediction 140 model.ckpt-192500 "" 0.10 0.10
run_evaluation prediction 140 model.ckpt-192500 "" 0.05 0.10
#run_evaluation prediction 140 model.ckpt-192500 "" 0.20 0.10

#run_evaluation prediction 140 model.ckpt-192500 "" 0.50 0.25
