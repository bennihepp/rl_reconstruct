...
#SCENE_ID=20
#SCENE_ID=30
OUTPUT_FOLDER=outputs_scenes/output_${CAMERA_NAME}_fixed_3
OUTPUT_FOLDER=outputs_scenes/output_${CAMERA_NAME}_new
...
run_evaluation prediction 140 model.ckpt-192500
