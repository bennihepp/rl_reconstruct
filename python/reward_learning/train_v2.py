    ...
    class InputPipeline(object):
        ...
        def __init__(self, filenames, queue_capacity, min_after_dequeue, shuffle, num_threads, name):
            ...
            self._hdf5_input_pipeline = data_record.HDF5ReaderProcessCoordinator(
                filenames, coord, shuffle=shuffle, hdf5_record_version=data_record.HDF5_RECORD_VERSION_2,
                timeout=args.async_timeout, num_processes=num_threads, verbose=args.verbose >= 2)
