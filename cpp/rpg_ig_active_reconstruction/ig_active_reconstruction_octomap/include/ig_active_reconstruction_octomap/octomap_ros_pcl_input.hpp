...
#include "ig_active_reconstruction_msgs/DepthMapInput.h"
#include "ig_active_reconstruction_msgs/ResetOctomap.h"
...
namespace octomap
{
  ...
  protected:
    ...
    /*! Depth map input service.
     */
    bool insertDepthMapService( ig_active_reconstruction_msgs::DepthMapInput::Request& req, ig_active_reconstruction_msgs::DepthMapInput::Response& res);

    /*! Reset octomap service.
     */
    bool resetOctomapService( ig_active_reconstruction_msgs::ResetOctomap::Request& req, ig_active_reconstruction_msgs::ResetOctomap::Response& res);
    ...
    /*! Inserts a depth image from a pinhole camera and calls issueInputDoneSignals when done.
     */
    void insertDepthMap(const Eigen::Transform<double,3,Eigen::Affine>& sensor_to_world_transform,
    ...
    /*! Converts a depth map from a pinhole camera into a point cloud.
     */
    POINTCLOUD_TYPE depthMapToPointCloud(
  ...
  private:
    ...
    ros::ServiceServer depth_input_service_;
    ros::ServiceServer reset_octomap_service_;
