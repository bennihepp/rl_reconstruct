...
{  
  ...
  public:
    ...
    RayCaster& getRayCaster() { return ray_caster_; }

    const RayCaster& getRayCaster() const { return ray_caster_; }
  ...
  protected:
    ...
    Eigen::Vector3d score_bbox_min_;
    Eigen::Vector3d score_bbox_max_;
  };
}
