...
namespace world_representation
{
  ...
  public:
    ...
    virtual RayCaster& getRayCaster() { return *reinterpret_cast<RayCaster*>(NULL); };
    virtual const RayCaster& getRayCaster() const { return *reinterpret_cast<const RayCaster*>(NULL); };
