...
#include "ig_active_reconstruction_msgs/SetScoreBoundingBox.h"
...
namespace world_representation
{
  ...
  public:
    ...
    /*! Set bounding box in which to count any occupied observations. Return false if this is not supported. */
    virtual bool setScoreBoundingBox(const Eigen::Vector3d& min, const Eigen::Vector3d& max);
    ...
    virtual RayCaster& getRayCaster() { return linked_interface_->getRayCaster(); };
    virtual const RayCaster& getRayCaster() const { return linked_interface_->getRayCaster(); };

  protected:
    bool setScoreBoundingBoxService( ig_active_reconstruction_msgs::SetScoreBoundingBox::Request& request, ig_active_reconstruction_msgs::SetScoreBoundingBox::Response& response );
  ...
  protected:
    ...
    ros::ServiceServer set_score_bounding_box_;
